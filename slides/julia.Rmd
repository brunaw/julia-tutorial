...
.large[Bruna Wundervald | Maynooth University | `r Sys.Date()`]
...
- Objects: lists, arrays, vectors, [...]

- Julia is very protective of it's base functions
  - You can't overwrite functions like the `sum`, `exp`, etc
...
```
using MLJ, StatsBase, Random, CategoricalArrays, DataFrames
using Plots
using XGBoost, MLJ
